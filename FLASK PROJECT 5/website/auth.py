...
from . import db
from .models import User, ProfilePicture, Listing, Ratings, Reports, Likes
    ...
    if user:
        ...
        if request.method == "POST":
            if foreign_profile:
                ...
                pass
        return render_template("user.html", current_user = current_user, userid = userid, foreign_profile = foreign_profile, user = user, profile_pictures_ = profile_pictures_, listing = listing, the_rating = the_rating, Reports = Reports, Likes = Likes)
    else:
